              ...
              <div className="flex flex-col px-8 w-full items-start space-y-[16px]">
                <div className="flex items-center space-x-4">
                  <div className="flex items-center space-x-2">
                    <HiOutlineTag className="w-5 h-5 text-[#008001]" />
                    <span>Food</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <BsFillPersonFill className="w-5 h-5 text-[#008001]" />
                    <span>By Admin</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <FaRegComment className="w-5 h-5 text-[#008001]" />
                    <span>Comments</span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between w-full">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <button className="hover:text-white hover:bg-[#008001] p-2 rounded-full">
                      <AiFillPinterest className="w-6 h-6" />
                    </button>
                    <button className="hover:text-white hover:bg-[#008001] p-2 rounded-full">
